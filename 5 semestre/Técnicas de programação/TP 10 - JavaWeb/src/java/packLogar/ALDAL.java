...
import static packLogar.AFDAL.conecta;
import static packLogar.AFDAL.desconecta;
...
public static void geraTabela(Object obj, String nomeBD)
{
...
AFDAL.conecta(nomeBD+".mdb");
AFDAL.executeSQL(sql);
AFDAL.desconecta();
}
public static void set(Object obj, String nomeBD)
{
Field[] f  = obj.getClass().getDeclaredFields();
...
public static void delete(Object obj, String nomeBD)
{
    Field[] f  = obj.getClass().getDeclaredFields();
...
public static void get(Object obj, String nomeBD)
{
    Field[] f  = obj.getClass().getDeclaredFields();
...
public static void update(Object dados, Object chaves, String nomeBD)
{
...
public static void geraClasse(String _tabela, String _package, String nomeBD) {
    ...
    Connection con = conecta(nomeBD+".mdb");
    Erro.setErro(false);
    try {
